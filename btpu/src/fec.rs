//! FEC extension message types and framework trait (draft-ietf-dtn-btpu-fec).
//!
...
//! codes, see [`MessageType`](crate::codec::message::MessageType).
...
/// Pre-agreed FEC Source message (provisional type 0x70).
///
...
/// Explicit FEC Source message (provisional type 0x71).
///
...
/// Pre-agreed FEC Repair message (provisional type 0x72).
///
...
/// Explicit FEC Repair message (provisional type 0x73).
///
