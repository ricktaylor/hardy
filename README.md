...
The server listens on **gRPC** (50051) and **TCPCLv4** (4556). Configuration is in [`bpa-server/config.yaml`](./bpa-server/config.yaml); edit it to change node settings. See the [bpa-server README](./bpa-server/README.md) for all options.
