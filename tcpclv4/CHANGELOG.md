...
### Removed
- The unmaintained `rustls-pemfile` dependency (RUSTSEC-2025-0134): PEM certificates and keys are loaded through `rustls::pki_types::pem::PemObject`.
