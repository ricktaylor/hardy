...
storage_meta_recovery_tests!(sqlite_recovery, storage_tests::sqlite_meta_setup);
...
storage_meta_tests!(postgres, storage_tests::postgres_meta_setup);

#[cfg(feature = "postgres")]
storage_meta_recovery_tests!(postgres_recovery, storage_tests::postgres_meta_setup);
...
#[cfg(feature = "s3")]
storage_blob_tests!(s3, storage_tests::s3_blob_setup);
