...
PING_OUTPUT=$(timeout $((PING_COUNT * 2 + 40))s "$BP_BIN" ping "ipn:$NODE2_NUM.7" "127.0.0.1:$NODE2_PORT" \
...
# Exit codes: 0=success (replies received), 1=no replies (100% loss), 2=error
# Capture output to check actual received count
PING_OUTPUT=$(timeout $((PING_COUNT * 2 + 40))s "$BP_BIN" ping "ipn:$NODE1_NUM.7" "127.0.0.1:$NODE1_PORT" \
