...
| 9.1.1 | Configurable location/credentials | **Pass** | Harness setup ([`PLAN-S3-01`](test_plan.md) §5) — every run supplies the endpoint and credentials via configuration; CI runs against RustFS |
