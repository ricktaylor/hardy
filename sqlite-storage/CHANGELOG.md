...
### Added
- `forward_ack_pending` status encoding (code 6), the `reset_peer_ack_pending` sweep, and the status-conditioned `swap_status`, for the deferred CLA transfer-outcome extension.
