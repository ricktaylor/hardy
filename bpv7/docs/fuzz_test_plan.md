...
| [**1.1.18**](../../docs/requirements.md#bpv7-parsing-11) | Parser must not fail when presented with unrecognised but correctly encoded flags. |
| [**1.1.21**](../../docs/requirements.md#bpv7-parsing-11) | Parser must parse and validate all CRC values. |
