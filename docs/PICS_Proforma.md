...
| **Implementation Name(s) and Version(s)** | Hardy, version 0.2.0, tag v0.2.0 |
...
| 41 | Fragmentation Procedures | Follows RFC 9171 procedures when fragmenting a bundle. (Mandatory if Item 40 is true). | RFC 9171 Sec 5.8 | C | N |
