...
impl hardy_bpa::bpa::BpaRegistration for RemoteBpa {
    async fn register_cla(
        ...
        register_cla(self.grpc_addr.clone(), name, address_type, cla).await
    }
    ...
    async fn register_service(
        ...
        register_endpoint_service(self.grpc_addr.clone(), service_id, service).await
    }
    ...
    async fn register_application(
        ...
        register_application_service(self.grpc_addr.clone(), service_id, application).await
    }
}
